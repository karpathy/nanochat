...
from tasks.mmlu_pro import MMLU_Pro
...
def run_chat_eval(task_name, model, tokenizer, engine,
    ...
    task_module = {
        ...
        'MMLU-Pro': partial(MMLU_Pro, split="test"),
    }[task_name]
...
if __name__ == "__main__":
    ...
    all_tasks = ['ARC-Easy', 'ARC-Challenge', 'MMLU', 'GSM8K', 'HumanEval', 'SpellingBee', 'MMLU-Pro']
    baseline_accuracies = {
        ...
        'MMLU-Pro': 0.1, # multiple choice 1 of 10 => 10%
    }
