...
parser.add_argument('--dataset', type=str, default='Salesforce/wikitext', help='Hugging Face dataset id')
parser.add_argument('--dataset-config', type=str, default='wikitext-103-raw-v1', help='Hugging Face dataset config')
parser.add_argument('--split', type=str, default='train', help='Dataset split')
parser.add_argument('--tokenizer-backend', choices=['rustbpe', 'hf'], default='rustbpe', help='Tokenizer implementation to train')
