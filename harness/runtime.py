"""
Running a script on this machine: distributed init and cleanup, device autodetect,
logging, the banner, a wandb stand-in, and the hardware tables behind MFU/MBU.
"""
...
from nanochat.common import print0, get_dist_info, get_base_dir
