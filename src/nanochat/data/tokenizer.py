...
class HuggingFaceTokenizer:
    ...
    def _encode_one(self, text: str, prepend: Optional[Union[str, int]] = None, append: Optional[Union[str, int]] = None, num_threads: Optional[int] = None) -> List[int]:
...
class RustBPETokenizer:
    ...
    def encode(self, text: Union[str, List[str]], prepend: Optional[Union[str, int]] = None, append: Optional[Union[str, int]] = None, num_threads: int = 8) -> Union[List[int], List[List[int]]]:
